...
Create new migration (new file in `answer/migrations/versions/`):
...
If u wanna create new file with tables u should import tables to `answer/migrations/env.py`

```
import answer.users.tables # import new files here
```
